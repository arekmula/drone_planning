...
nav_msgs::Path Planner3D::planPath(const octomap_msgs::Octomap& octomapMsg)
{
    ...
    ompl::base::PlannerStatus solved = planner->ompl::base::Planner::solve(2.0);
    ...
    while (solved != ompl::base::PlannerStatus::EXACT_SOLUTION)
    {
        ...
        solved = planner->ompl::base::Planner::solve(2.0);
    }
    ...
    /* TODO: Try to save tree generated by planner in each solution to use it in next planning.
    * Maybe move something to configuration
    */
    return plannedPath;
